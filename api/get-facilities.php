...
$query = "SELECT id, lat, lng, name, address, facilityType, seatingCapacity, facilityScale, earthquakeHazard, tsunamiHazard, 	windAndFloodDamage, volcanicHazard, other FROM ".Table_Facilities." WHERE address LIKE '".$prefecture."%'";
