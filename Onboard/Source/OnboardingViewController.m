...
static CGFloat const kSkipButtonWidth = 30;
static CGFloat const kSkipButtonHeight = 30;
...
- (void)generateView {
    ...
    if (self.allowSkipping) {
        self.skipButton.frame = CGRectMake(CGRectGetMaxX(self.view.frame) - kSkipButtonWidth - 20, 32, kSkipButtonWidth, kSkipButtonHeight);
