...
- (instancetype)initWithTitle:(NSString *)title body:(NSString *)body image:(UIImage *)image videoURL:(NSURL *)videoURL buttonText:(NSString *)buttonText actionBlock:(action_callback)actionBlock {
    ...
    self.buttonFontName = @"HiraSansOldStdN-W7";
    ...
    self.buttonTextColor = [UIColor colorWithRed: 0.219 green: 0.8 blue: 0.713 alpha: 1.0];
...
- (void)generateView {
    ...
    self.view.backgroundColor = self.buttonTextColor;
    ...
    if (_buttonText) {
        ...
        _actionButton.font = [UIFont boldSystemFontOfSize: 18];
